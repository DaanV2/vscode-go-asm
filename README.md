...
A vscode extension for showing you Go's assembly output next with your Go code. Inspired by the godbolt compiler explorer, because I want something local on my current project.
